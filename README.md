...
DTAT-OCR includes a `/ocr` endpoint designed for integration passthrough — accepts raw image binary via POST and returns extracted text directly. This enables any integration platform via simple HTTP POST with no scripting required.
